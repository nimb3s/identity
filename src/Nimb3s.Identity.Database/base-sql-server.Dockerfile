...
#docker build -f "C:\git\identity\src\Nimb3s.Identity.Database\base-sq-server.Dockerfile" -t nimb3s/base-sql-server:2019-latest --force-rm "C:\git\identity" --progress plain --no-cache
